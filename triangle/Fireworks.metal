...
float simpleRand(float seed) { return fract(sin(seed) * 43758.5453123); }

float randBalanced(float seed) { return simpleRand(seed) * 2.0 - 1.0; }

float3 fiboGridN(float n, float total) {

...
struct FractalUmbrellaView: View {
  ...
  func getModelComponent(mesh: LowLevelMesh) throws -> ModelComponent {
    ...
    var unlitMaterial = UnlitMaterial(color: UIColor(red: 1, green: 0.6, blue: 0.6, alpha: 0.8))
  ...
  func createMesh() throws -> LowLevelMesh {
    ...
    buildUmbrella(
      p0: SIMD3<Float>(0, 0, 0), v0: v0, relative: v1, parts: 4, elevation: 0.9 * Float.pi,
      decay: 0.5,
      step: 11,
      write: write)
